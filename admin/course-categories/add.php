...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_category'])) {
    try {
        ...
        // Verify unique slug
        $checkStmt = $db->prepare("SELECT id FROM course_categories WHERE slug = :slug LIMIT 1");
        $checkStmt->execute(['slug' => $slug]);
        if ($checkStmt->fetch()) {
            throw new Exception("The slug '{$slug}' is already occupied. Please provide a unique slug.");
        }
        ...
        $schemaArray = [
            ...
            "@type" => "ItemList",
            "name" => $name,
            "description" => $description ?: "Explore all courses in " . $name,
            "url" => "https://mgedu.in/courses/" . $slug
        ];
        $seo_schema = json_encode($schemaArray, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);

        // Perform Database Insert
        $stmt = $db->prepare("
            INSERT INTO course_categories (name, slug, description, meta_title, meta_description, meta_keywords, seo_schema)
            VALUES (:name, :slug, :description, :meta_title, :meta_description, :meta_keywords, :seo_schema)
        ");
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    text: 'The category was registered successfully!',
        ...
        <form method="POST" action="" id="categoryForm">
            ...
            <div class="admin-card">
                <div class="admin-header">
                    <h3><i class="fa-solid fa-folder-plus"></i> Category General Specifications</h3>
                </div>
                
                <div class="admin-body">
                    <div class="mb-4">
                        <label class="form-label" for="name">Category Name</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Computer Science" required autocomplete="off">
                    </div>

                    <div class="mb-4">
                        <label class="form-label" for="slug">URL Slug <span class="seo-indicator-badge">Auto / Customizable</span></label>
                        <div class="slug-wrapper">
                            <input type="text" name="slug" id="slug" class="form-control" placeholder="computer-science" required readonly>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5" placeholder="Provide category detailed context..." style="resize: none;"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card">
                ...
                <div class="admin-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="form-control" placeholder="Computer Science Wing - MG Education">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="meta_description" id="meta_description" class="form-control" rows="3" placeholder="Explore industry-oriented computer science and vocational software engineering courses at MG Education." style="resize: none;"></textarea>
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" placeholder="computer science, courses, software engineering, coding classes">
            ...
            <div class="mb-5">
                <button type="submit" name="save_category" class="btn-green-premium me-2">
                    <i class="fa-solid fa-floppy-disk"></i> Register Category
                </button>
    ...
    <div class="col-lg-4">
        <div class="admin-card">
            ...
            <div class="admin-body">
                ...
                <div class="schema-preview-box" id="schemaPreview">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "[Category Name]",
