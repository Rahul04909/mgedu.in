 ...
 * Admin Panel - Manual Course Student Enrollment Wizard
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_admission'])) {
    ...
    try {
        ...
        try {
            ...
            // 2. Write Core student registry profile to admissions table
            $stmt = $db->prepare("
                INSERT INTO `admissions` (
                    ...
                    'admin', :enrollment_number, :course_id, :session_name, :student_name, :dob, :email, :mobile, :gender,
                    :highest_qualification, :school_name, :aadhaar_number, :pan_number, :aadhaar_card,
                    :class_10_roll, :class_10_board, :class_10_school, :class_10_marksheet,
                    :class_12_roll, :class_12_board, :class_12_school, :class_12_marksheet,
                    :college_name, :college_roll, :college_degree, :college_passing_year,
            ...
            $feeIns = $db->prepare("
                ...
                VALUES (?, 'course', ?, ?, 'paid', ?, 'ADMIN_DIRECT')
            ");
            $feeIns->execute([$admission_id, $enrollment_number, $course_sales_price, $relativeReceipt]);
        ...
        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);'>
            ...
            <div style='padding: 30px; background: #ffffff;'>
                ...
                <p style='color: #475569; font-size: 15px; line-height: 1.6;'>Congratulations! Your admission has been manually submitted and confirmed by our authorized regional franchise center. Your student profile is successfully created in our global registry database.</p>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="course_id" id="course_id" class="form-select form-control" required>
                                    ...
                                    <?php foreach ($courses as $c): ?>
                                        <option value="<?= $c['id'] ?>"><?= htmlspecialchars($c['name']) ?> (₹<?= number_format($c['sales_price'], 2) ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
