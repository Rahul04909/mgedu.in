...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_category'])) {
    try {
        ...
        // Verify unique slug
        $checkStmt = $db->prepare("SELECT id FROM internship_categories WHERE slug = :slug LIMIT 1");
        ...
        $stmt = $db->prepare("
            INSERT INTO internship_categories (name, slug, description, meta_title, meta_description, meta_keywords, seo_schema)
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    text: 'The internship category was registered successfully!',
            ...
            <div class="admin-card">
                ...
                <div class="admin-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Web Development" required autocomplete="off">
                    </div>

                    <div class="mb-4">
                        <label class="form-label" for="slug">URL Slug <span class="seo-indicator-badge">Auto / Customizable</span></label>
                        <div class="slug-wrapper">
                            <input type="text" name="slug" id="slug" class="form-control" placeholder="web-development" required readonly>
            ...
            <div class="admin-card">
                ...
                <div class="admin-body">
                    <div class="mb-4">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="form-control" placeholder="Web Development Internships - MG Education">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="meta_description" id="meta_description" class="form-control" rows="3" placeholder="Explore hands-on Web Development and Software Engineering internship programs at MG Education." style="resize: none;"></textarea>
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" placeholder="web development internships, computer software internship, live project training">
