 ...
 * Student Profile & Password Management - Internship Dashboard
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_password') {
    ...
    try {
        $stmtUpd = $db->prepare("UPDATE `internship_admissions` SET `password` = ? WHERE `id` = ? AND `status` = 'confirmed'");
...
// Fetch complete student and internship details
try {
    $stmt = $db->prepare("
        SELECT a.*, i.name as internship_name, i.duration, i.duration_unit
        ...
        <div class="profile-card">
            ...
            <div class="text-start" style="font-size: 13.5px;">
                <div class="mb-2">
                    ...
                    <div class="text-dark font-weight-bold mt-1"><?= htmlspecialchars($student['internship_name']) ?></div>
                </div>
                <div class="mb-2">
                    <strong class="text-secondary">Internship Duration:</strong>
