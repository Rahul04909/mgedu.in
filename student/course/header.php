...
// Route authorization guard: must have course role and confirmed enrollment
if (!isset($_SESSION['student_role']) || $_SESSION['student_role'] !== 'course' || empty($_SESSION['student_enrollment'])) {
...
try {
    ...
    $stmt = $db->prepare("SELECT * FROM `admissions` WHERE `enrollment_number` = ? AND `status` = 'confirmed'");
...
$menuItems = [
    ...
    [
        "menuTitle" => "Academic Course",
        "icon" => "fas fa-graduation-cap",
        "pages" => [
            ["title" => "Course Details", "url" => "course_details.php"]
        ],
    ],
    [
        "menuTitle" => "Settings",
